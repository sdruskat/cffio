...
On a structural level, the Citation File Format project is a collection of <!-- [subprojects](#subprojects)  -->
subprojects that are organized in an [organization of repositories](https://github.com/citation-file-format).
Subprojects include, for example, 
[the format and its schema](https://github.com/citation-file-format/citation-file-format), 
[the project website](https://github.com/citation-file-format/citation-file-format.github.io), 
